...
<!--            <div class="menu_text">Menu</div>   -->
        ...
        <div class="menu_wrap">
          ...
          <div class="menu_left_col">
            <div class="link_wrap">
              <div class="link_title"><a href="index.php">Home</a></div>
            </div>
            <div class="link_wrap">
              <div class="link_title"><a href="about.php">About Us</a></div>
              <ul class="sublinks">
                <li><a href="about.php#company">Our Company</a></li>
                <li><a href="about.php#value">Value Proposition</a></li>
                <li><a href="about.php#team">Our Team</a></li>
                <li><a href="about.php#advisors">Advisors</a></li>
                <li><a href="about.php#csr">Community Programmes</a></li>
                <li><a href="about.php#faq">FAQs</a></li>
              </ul>
            </div>
            <div class="link_wrap">
              <div class="link_title"><a href="solutions.php">Our Solutions</a></div>
              <ul class="sublinks">
          ...
          <div class="menu_right_col">
            <div class="link_wrap">
              <div class="link_title"><a href="industries.php">Industries</a></div>
              <ul class="sublinks">
            ...
            <div class="link_wrap">
              <div class="link_title"><a href="portfolio.php">Portfolio</a></div>
            </div>
            <div class="link_wrap">
              <div class="link_title"><a href="newsroom.php">Newsroom</a></div>
              <ul class="sublinks">
                <li><a href="">Blog</a></li>
            ...
            <div class="link_wrap">
              <div class="link_title"><a href="careers.php">Careers</a></div>
            </div>
            <div class="link_wrap">
              <div class="link_title"><a href="contact.php">Contact Us</a></div>
            </div>
          </div>
      ...
      <div class="banner" style ="background-image: url(media/team2.jpeg)">
